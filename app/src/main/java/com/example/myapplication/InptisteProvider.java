...
public class InptisteProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME = "com.example.myapplication.InptisteProvider";
    ...
    static final String JOUR_DE_NAISSANCE = "jour_de_naissance";
    ...
    static {
     ...
     " email TEXT NOT NULL," +
     " jour_de_naissance TEXT NOT NULL);";
